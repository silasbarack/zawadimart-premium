...
export const products = [
  ...
  P(61,'Ailyons 2L Stainless Steel Electric Kettle','home-kitchen',1199,1499,4.5,688,82,'Top Seller','https://images.unsplash.com/photo-1594213114663-d94db9b17125?auto=format&fit=crop&w=900&q=88','Fast-boil 2-litre stainless steel kettle with automatic shut-off and boil-dry protection.'),
  P(62,'Roch 200L Chest Freezer','home-appliances',30999,38300,4.6,118,12,'Freezer Deal','https://images.unsplash.com/photo-1626806775351-5c3a44b498fe?auto=format&fit=crop&w=900&q=88','Large-capacity chest freezer suitable for family use, shops and small food businesses.'),
  P(63,'Ramtons Hot & Normal Water Dispenser','home-appliances',8999,10999,4.5,286,22,'Home Essential','https://images.unsplash.com/photo-1606760227091-3dd870d97f1d?auto=format&fit=crop&w=900&q=88','Freestanding hot and normal water dispenser with easy-access taps and storage cabinet.'),
  P(64,'Vision Plus 32-inch Frameless Digital TV','electronics',13999,15999,4.5,385,27,'TV Deal','https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=900&q=88','Compact frameless television with digital tuner, HDMI and USB connectivity for everyday viewing.'),
  P(65,'Vitron 43-inch Smart Android TV','electronics',22999,27999,4.4,241,19,'Smart TV','https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=900&q=88','43-inch smart Android television with streaming apps, Wi-Fi and multiple HDMI inputs.'),
  P(66,'Tecno Camon 30 256GB 8GB RAM','phones-tablets',32999,36999,4.6,212,23,'Camera Phone','https://images.unsplash.com/photo-1598327105666-5b89351aff97?auto=format&fit=crop&w=900&q=88','Stylish Android smartphone with generous storage, strong cameras and fast charging.'),
  P(67,'Samsung Galaxy A26 5G 128GB','phones-tablets',36999,41999,4.7,174,18,'5G Pick','https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&w=900&q=88','5G-ready Samsung smartphone with smooth AMOLED display, capable cameras and long battery life.'),
  P(68,'HP EliteBook 840 G8 Core i5 16GB 512GB','computing',58999,64999,4.7,149,11,'Business Laptop','https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=900&q=88','Slim business laptop with 16GB RAM, 512GB SSD and a durable professional chassis.'),
  P(69,'Oraimo FreePods Wireless Earbuds','audio',3299,4299,4.5,527,61,'Popular Audio','https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?auto=format&fit=crop&w=900&q=88','Lightweight wireless earbuds with clear calls, punchy sound and pocket charging case.'),
  P(70,'Nunix 4-Burner Gas Cooker with Oven','home-appliances',18999,22999,4.4,107,14,'Kitchen Upgrade','https://images.unsplash.com/photo-1556911220-bff31c812dba?auto=format&fit=crop&w=900&q=88','Four-burner freestanding gas cooker with oven and grill for everyday family cooking.'),
  P(71,'Men Casual Two-piece Short Set','fashion',2299,2999,4.4,193,43,'Weekend Style','https://images.unsplash.com/photo-1617137968427-85924c800a22?auto=format&fit=crop&w=900&q=88','Comfortable matching shirt-and-shorts set designed for casual weekends and warm weather.'),
  P(72,'Ladies Classic Office Handbag','fashion',3499,4499,4.6,216,37,'Office Style','https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=900&q=88','Structured everyday handbag with practical compartments and polished office styling.'),
];
